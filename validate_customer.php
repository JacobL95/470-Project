    ...
    <?php include "utility_customer.php";
          include 'page_layout_customer.php';
        ...
        switch ($result){
          ...
          default: //Driver has login and return data.
            ...
            echo table_head($row['CUSTOMER_FIRST_NAME']." ".$row['CUSTOMER_LAST_NAME']);
            $result->data_seek(0);
            while($row = $result->fetch_assoc())
            {
                echo '
                <tr>
                  <td style="width:10%;" align= "left">'.  $row["DRIVER_FIRST_NAME"]." ".$row["DRIVER_LAST_NAME"].'</td>
